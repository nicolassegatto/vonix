...
export function BlogCard() {
  ...
  if (isMobile) {
    return (
      <div
        className="grid grid-rows-2 rounded-xl p-6"
        style={{
      ...
      >
        ...
        <div className="row-span-1 flex flex-col gap-3 rounded-xl bg-gray-500 bg-opacity-50 p-4 text-white backdrop-blur-3xl">
          <h1 className="text-lg font-bold">{title}</h1>
          <p className="text-sm">{description}</p>
          <Button
            asChild
            className="bg-vonix-orange-600 text-xl font-bold"
          >
